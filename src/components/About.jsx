...
export default function About() {
  return (
    <section name="about" className="mesh-light my-6 py-24 md:my-8 md:py-32">
      <div className="section-shell grid gap-12 md:grid-cols-[.7fr_1.3fr]">
        ...
        <div className="max-w-2xl md:pt-12">
          <p className="text-2xl font-semibold leading-tight text-white md:text-4xl">Scalable interfaces, thoughtful systems and AI-ready frontend engineering.</p>
