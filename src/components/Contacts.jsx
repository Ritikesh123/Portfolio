  ...
  return (
    <footer name="contact" className="mesh-dark my-6 py-24 text-white md:my-8 md:py-32">
      <div className="section-shell">
        ...
        <div className="mt-12 flex flex-wrap gap-3"><a href="mailto:ritikesh.raj04@gmail.com" target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 rounded-full bg-white px-6 py-4 text-sm font-bold text-[#101114] transition hover:-translate-y-1">ritikesh.raj04@gmail.com <FiMail /></a><a href="https://wa.me/918538946710" target="_blank" rel="noreferrer" className="inline-flex items-center rounded-full border border-white/20 px-6 py-4 text-sm font-bold transition hover:bg-white/10">WhatsApp · +91 85389 46710</a></div>
